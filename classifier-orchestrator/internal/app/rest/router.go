...
func NewRouter(logger *slog.Logger, createClassUseCase create_class.UseCase, listClassesUseCase list_classes.UseCase, updateClassUseCase update_class.UseCase) *chi.Mux {
	r := chi.NewRouter()
